 ...
 * @author ANPHUOC
 */
@WebServlet(name = "CheckOrderController", urlPatterns = {"/CheckOrderController"})
public class CheckOrderController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Order> orders = orderDAO.getListOrders(loginUser.getUserID());
            ...
            log("Error at CheckOrderController: " + e.toString());
        }finally{
